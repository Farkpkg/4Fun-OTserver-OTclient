logger.info("Updating database to version 65 (weekly tasks FK alignment fix)")

-- If v64 ran with incompatible FK types, rebuild weekly tables with players.id-compatible types.

db.query("SET FOREIGN_KEY_CHECKS = 0;")

db.query("DROP TABLE IF EXISTS `player_weekly_task_entries`;")
db.query("DROP TABLE IF EXISTS `player_weekly_unlocks`;")
db.query("DROP TABLE IF EXISTS `player_weekly_tasks`;")
