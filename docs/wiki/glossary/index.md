...
[Wiki](../index.md) > Glossário

# Glossário orientado a IA

## Termos gerais
- **CrystalServer**: servidor Open Tibia deste repositório. (Ver [Servidor](../server/index.md).)
- **OTClient**: cliente customizado do jogo. (Ver [Cliente](../client/index.md).)
- **OpCode**: identificador numérico de mensagens do protocolo. (Ver [Protocolos](../protocol/index.md).)
