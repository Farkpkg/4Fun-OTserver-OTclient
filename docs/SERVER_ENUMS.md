...
These are the message types used by the Linked Tasks system when calling `player:sendTextMessage`. See `docs/ENUMS_MESSAGE_TYPES.md` for the canonical list and origins.
