...
## API
- Métodos públicos: create, isPlaying, play, removeEffect, setEffect, setFading, setGain, setLooping, setName, setPosition, setReferenceDistance, setRelative, setVelocity, stop
- Campos/fieldmethods: -

## Herança e dependências
- Chain `__index`: SoundSource
