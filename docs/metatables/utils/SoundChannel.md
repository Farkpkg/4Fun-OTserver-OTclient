...
## API
- Métodos públicos: disable, enable, enqueue, getGain, getId, isEnabled, play, setEnabled, setGain, stop
- Campos/fieldmethods: -

## Herança e dependências
- Chain `__index`: SoundChannel
- Dependências: LuaInterface, LuaObject

## Exemplos reais (extração direta)
- `otclient/src/framework/luafunctions.cpp:1112`
