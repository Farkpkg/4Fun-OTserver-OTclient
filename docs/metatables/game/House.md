...
## API
- Métodos públicos: addDoor, create, getEntry, getId, getName, getRent, getSize, getTile, getTownId, removeDoor, removeDoorById, setEntry, setId, setName, setRent, setSize, setTile, setTownId
- Campos/fieldmethods: -
