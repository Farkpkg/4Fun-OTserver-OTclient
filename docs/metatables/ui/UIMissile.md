...
## API
- Métodos públicos: clearMissile, create, getDirection, getMissile, getMissileId, isMissileVisible, isVirtual, setDirection, setMissile, setMissileId, setMissileVisible, setVirtual
- Campos/fieldmethods: -

## Herança e dependências
- Chain `__index`: UIMissile -> UIWidget
