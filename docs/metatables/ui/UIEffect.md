...
## API
- Métodos públicos: clearEffect, create, getEffect, getEffectId, isEffectVisible, isVirtual, setEffect, setEffectId, setEffectVisible, setVirtual
- Campos/fieldmethods: -

## Herança e dependências
- Chain `__index`: UIEffect -> UIWidget
