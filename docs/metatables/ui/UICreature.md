...
## API
- Métodos públicos: create, getCreature, getCreatureSize, getDirection, isCentered, setCenter, setCreature, setCreatureSize, setDirection, setOutfit
- Campos/fieldmethods: -

## Herança e dependências
- Chain `__index`: UICreature -> UIWidget
